            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    <div class="ipb-form">
                        ...
                        <div class="form"><br>
                            <center>
                                <h2>Izin Pekerjaan Berbahaya Ruangan Terbatas</h2>
                            </center>
                            <hr>
                            {{-- Hint --}}
                            <small>*Silahkan isi form IPB Ruangan Terbatas</small>
                            {{-- /Hint --}}

                            <form action="/IPB/ruang-terbatas" method="post">
...
<script type="text/javascript" src="{{ URL::asset('js/jquery-1.4.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/jquery.sheepItPlugin.js') }}"></script>
<script>

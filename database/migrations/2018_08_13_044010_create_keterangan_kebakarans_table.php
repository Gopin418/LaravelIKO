...
class CreateKeteranganKebakaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('keterangan_kebakarans', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('keterangan_kebakarans');
    }
}

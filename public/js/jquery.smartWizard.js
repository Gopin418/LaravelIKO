...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-primary float-right sw-btn-next mb-2 col-sm-2').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-outline-secondary mb-2 float-left sw-btn-prev col-sm-2').attr('type', 'button') : null;
            var btnFinish = $('.sw-btn-finish');
            var btnGroup = $('<div></div>').addClass('col-sm-12 mr-2 sw-btn-group').attr('role', 'group').append(btnPrevious, btnNext, btnFinish);
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                if (0 >= idx) {
                    $('.sw-btn-prev', this.main).css('display', 'none')
                } else {
                    $('.sw-btn-prev', this.main).css('display', '')
                }
                if (this.steps.length - 1 <= idx) {
                    $('.sw-btn-next', this.main).css('display', 'none');
                    $('.sw-btn-finish').css('display', '');
                } else {
                    $('.sw-btn-next', this.main).css('display', '');
